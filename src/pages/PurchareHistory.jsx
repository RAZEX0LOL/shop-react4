...
const PurchaseHistory = () => {
	...
	if (loading) {
		return (
			<div className="container mx-auto p-4 text-gray-800 dark:text-gray-300">
		...
		<div className="container mx-auto p-4 bg-white dark:bg-gray-800 transition-colors duration-300">
			...
			{orders.length === 0 ? (
				...
				orders.map(order => (
					<div
						key={order.id}
						className="mb-6 p-4 bg-white dark:bg-gray-900 shadow rounded transition-colors duration-300"
					>
